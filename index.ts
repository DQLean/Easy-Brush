...
export { type DynamicShapeConfig } from './types/dynamicShape'
export { type DynamicTransparencyConfig } from './types/dynamicTransparency'
export { type SpreadConfig } from './types/spread'